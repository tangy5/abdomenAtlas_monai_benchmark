...
parser.add_argument("--logdir", default="swinunetr_0425", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
...
parser.add_argument("--max_epochs", default=30000, type=int, help="max number of training epochs")
...
parser.add_argument("--distributed", default=True, type=bool, help="start distributed training")
...
parser.add_argument("--use_normal_dataset", default=False, type=bool, help="use monai Dataset class")
...
parser.add_argument("--infer_overlap", default=0.3, type=float, help="sliding window inference overlap")
parser.add_argument("--lrschedule", default="warmup_cosine", type=str, help="type of learning rate scheduler")
parser.add_argument("--warmup_epochs", default=50, type=int, help="number of warmup epochs")
parser.add_argument("--resume_ckpt", action="store_true", help="resume training from pretrained checkpoint")
parser.add_argument("--smooth_dr", default=1e-6, type=float, help="constant added to dice denominator to avoid nan")
parser.add_argument("--smooth_nr", default=0.0, type=float, help="constant added to dice numerator to avoid zero")
parser.add_argument("--use_checkpoint", default=True, type=bool,  help="use gradient checkpointing to save memory")
parser.add_argument("--use_ssl_pretrained", default=True, type=bool, help="use self-supervised pretrained weights")
...
#                       window_size=[7, 7, 7])
    ...
    if args.squared_dice:
        ...
        dice_loss = DiceCELoss(to_onehot_y=True, softmax=True, reduction="sum")
